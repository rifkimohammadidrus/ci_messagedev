...
<div class="mobile-menu-left-overlay"></div>
	<nav class="side-menu">
	    <ul class="side-menu-list">
	        <li class="grey <?php if($this->uri->segment(1)=="dashboard"){echo "opened";}?>">
	            ...
	            <span>
					...
					<li class="purple <?php if($this->uri->segment(1)=="user_account"){echo "opened";}?>">
	            <a href="<?= base_url(); ?>user_account">
								<i class="font-icon font-icon-user"></i>
								<span class="lbl">User Acount</span>
	            </a>
	        </li>
					
					<li class="pink <?php if($this->uri->segment(1)=="member_wha"){echo "opened";}?>">
						<a href="<?= base_url(); ?>member_wha">
							<i class="font-icon font-icon-users"></i>
							<span class="lbl">Member Wha</span>
						</a>
	        </li>
	        <li class="blue <?php if($this->uri->segment(1)=="group_wha"){echo "opened";}?>">
						<a href="<?= base_url(); ?>group_wha"> 
							<i class="font-icon font-icon-users-group"></i>
							<span class="lbl">Group Wha</span>
						</a>
	        </li>
					
					<li class="purple <?php if($this->uri->segment(1)=="template_msg"){echo "opened";}?>">
							<a href="<?= base_url(); ?>template_msg">
								<i class="font-icon font-icon-comments"></i>
								<span class="lbl">Template Message</span>
							</a>
					</li>
					<li class="aquamarine <?php if($this->uri->segment(1)=="kirim_pesan"){echo "opened";}?>">
	            <a href="<?= base_url(); ?>kirim_pesan">
	                <i class="font-icon font-icon-mail"></i>
	                <span class="lbl">Kirim pesan</span>
	            </a>
	        </li>
					<li class="blue <?php if($this->uri->segment(1)=="history"){echo "opened";}?>">
	            <a href="<?= base_url(); ?>history">
	                <i class="font-icon glyphicon glyphicon-send"></i>
	                <span class="lbl">History pesan</span>
	            </a>
	        </li>
					<li >
