	...
	<script type="text/javascript" src="<?= base_url(); ?>asset/js/lib/jqueryui/jquery-ui.min.js"></script>
	<script type="text/javascript" src="<?= base_url(); ?>asset/js/lib/lobipanel/lobipanel.min.js"></script>
